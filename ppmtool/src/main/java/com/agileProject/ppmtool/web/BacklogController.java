...
import com.agileProject.ppmtool.services.ProjectTaskService;
...
public class BacklogController {
	...
	public ResponseEntity<?> getPojectTask(@PathVariable String backlog_id, 
	...
	public ResponseEntity<?> updateProjectTask(@Valid @RequestBody ProjectTask projectTask, BindingResult result,
		...
		ProjectTask updatedTask = projectTaskService.updateByProjectSequence(projectTask, backlog_id.toUpperCase(), pt_id.toUpperCase());
